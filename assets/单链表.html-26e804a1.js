import{_ as n,V as s,W as a,Y as e}from"./framework-bf44ac98.js";const t={},p=e(`<h1 id="单链表的结点定义" tabindex="-1"><a class="header-anchor" href="#单链表的结点定义" aria-hidden="true">#</a> 单链表的结点定义</h1><div class="language-cpp line-numbers-mode" data-ext="cpp"><pre class="language-cpp"><code><span class="token keyword">struct</span> <span class="token class-name">ListNode</span> <span class="token punctuation">{</span>
